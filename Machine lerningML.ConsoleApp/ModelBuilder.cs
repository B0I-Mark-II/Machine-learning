...
using Machine_lerningML.Model;

namespace Machine_lerningML.ConsoleApp
{
    public static class ModelBuilder
    {
        private static string TRAIN_DATA_FILEPATH = @"C:\Users\abunc_bhny1hc\OneDrive\Desktop\programing\C#\Data\wikipedia-detox-250-line-data.tsv.txt";
        private static string MODEL_FILEPATH = @"../../../../Machine_lerningML.Model/MLModel.zip";
